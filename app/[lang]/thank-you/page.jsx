  ...
  return (
    <section className="max-w-3xl mx-auto text-center py-24 px-6">
      <h1 className="text-3xl font-bold text-blue-900 mb-6">
        {lang === "es" ? "¡Gracias por su apoyo!" : "Thank You for Your Support!"}
      </h1>

      <p className="text-lg text-gray-700 mb-6">
        {lang === "es"
          ? "Su generosidad ayuda a compartir el mensaje de Cristo y fortalecer a otros en la fe."
          : "Your generosity helps share Christ-centered resources and strengthen others in faith."}
      </p>
      ...
      <blockquote className="italic text-gray-700 mb-8">
        ...
        <br />
        <span className="block mt-2 font-medium">— 2 Corinthians 9:7</span>
      </blockquote>
